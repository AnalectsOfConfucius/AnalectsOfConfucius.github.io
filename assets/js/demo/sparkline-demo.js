$(function () {
    ...
    $("#sparkline71").sparkline([52, 12, 44], {
        type: 'pie',
        height: '150px',
        sliceColors: ['#1ab394', '#b3b3b3', '#e4f0fb']});

    $("#sparkline72").sparkline([52, 12, 44], {
        type: 'pie',
        height: '150px',
        sliceColors: ['#1ab394', '#b3b3b3', '#e4f0fb']});

    $("#sparkline73").sparkline([52, 48], {
        type: 'pie',
        height: '150px',
        sliceColors: ['#1ab394', '#e4f0fb']});

     $("#sparkline74").sparkline([52, 48], {
        type: 'pie',
        height: '150px',
